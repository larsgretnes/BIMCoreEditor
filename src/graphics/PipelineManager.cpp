...
namespace BimCore {
    ...
    void PipelineManager::BuildLayouts() {
        // Scene Layout
        {
            ...
            sceneEntries[0].visibility = WGPUShaderStage_Vertex | WGPUShaderStage_Fragment;
            sceneEntries[0].buffer.type = WGPUBufferBindingType_Uniform; 
            sceneEntries[0].buffer.minBindingSize = sizeof(SceneUniforms);
            
            sceneEntries[1].binding = 1; 
            sceneEntries[1].visibility = WGPUShaderStage_Vertex;
            sceneEntries[1].buffer.type = WGPUBufferBindingType_ReadOnlyStorage; 
            sceneEntries[1].buffer.minBindingSize = sizeof(glm::mat4);
        ...
        // Shadow Layout
        {
            ...
            shadowEntries[0].visibility = WGPUShaderStage_Fragment;
            shadowEntries[0].texture.sampleType = WGPUTextureSampleType_Depth; 
            shadowEntries[0].texture.viewDimension = WGPUTextureViewDimension_2D;
            
            shadowEntries[1].binding = 1; 
            shadowEntries[1].visibility = WGPUShaderStage_Fragment; 
            shadowEntries[1].sampler.type = WGPUSamplerBindingType_Comparison;
            
            WGPUBindGroupLayoutDescriptor shadowDesc = {}; 
            shadowDesc.entryCount = 2; 
            shadowDesc.entries = shadowEntries;
        ...
        // SSAO Layout
        {
            ...
            bgle[0].binding = 0; 
            bgle[0].visibility = WGPUShaderStage_Fragment | WGPUShaderStage_Vertex;
    ...
    void PipelineManager::BuildPipelines() {
        // 1. Shadow Pipeline
        {
            ...
            pld.bindGroupLayouts = &m_sceneLayout;
        ...
        // 2. Main Opaque & Transparent Pipelines
        {
            ...
            frag.module = shader; 
            frag.entryPoint = WGPUStringView{"fs_opaque", 9}; 
            frag.targetCount = 1; 
            ...
            transFrag.entryPoint = WGPUStringView{"fs_transparent", 14}; 
        ...
        // 3. Highlight Pipelines (Solid & Outline)
        {
        ...
        // 5. Glass / Clipping Plane Pipeline
        {
            ...
            // <--- THE FIX: Set to True to prevent alpha compounding/layering on intersecting planes
            ds.depthWriteEnabled = WGPUOptionalBool_True; 
        ...
        // 6. Stencil Mask & Cap Pipeline (Section cuts)
        {
            ...
            maskDs.depthCompare = WGPUCompareFunction_Always; 
            ...
            frontFace.passOp = WGPUStencilOperation_IncrementWrap; 
            ...
            backFace.passOp = WGPUStencilOperation_DecrementWrap; 
            ...
            pdMask.primitive.cullMode = WGPUCullMode_None; 
        ...
        // 8. SSAO Pipeline
        {
            ...
            WGPUPipelineLayoutDescriptor pld = {}; 
            pld.bindGroupLayoutCount = 1; 
            pld.bindGroupLayouts = &m_ssaoLayout;
            WGPUPipelineLayout layout = wgpuDeviceCreatePipelineLayout(m_device, &pld);
