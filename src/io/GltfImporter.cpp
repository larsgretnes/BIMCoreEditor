...
// Defined ONLY in the Importer to prevent linker duplication errors!
...
namespace BimCore {
    ...
    void GltfImporter::Import(const std::string& filepath, std::shared_ptr<SceneModel> document) {
